...
cvector2 vector2_slide(cvector2 a, cvector2 b);
cvector2 vector2_reflect(cvector2 direction, cvector2 normal);
...
cvector3 vector3_reflect(cvector3 direction, cvector3 normal);
...
cvector4 vector4_slide(cvector4 a, cvector4 b);
cvector4 vector4_reflect(cvector4 direction, cvector4 normal);
