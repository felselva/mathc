...
MATHC_INLINE struct quat *psquat_multiply_f(struct quat *result, struct quat *a, mfloat_t f)
{
	quat_multiply_f((mfloat_t *)result, (mfloat_t *)a, f);
	return result;
}
...
MATHC_INLINE struct quat squat_multiply_f(struct quat a, mfloat_t f)
{
	struct quat result;
	quat_multiply_f((mfloat_t *)&result, (mfloat_t *)&a, f);
	return result;
